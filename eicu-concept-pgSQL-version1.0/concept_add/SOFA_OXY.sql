...
respiratorycare AS (
SELECT * FROM eicu.respiratorycare),
...
physicalexam AS (
SELECT * FROM eicu.physicalexam),

diag AS (
SELECT * FROM eicu.diagnosis),

chart AS (
SELECT * FROM eicu.nursecharting),

apsiii_raw AS (
SELECT * FROM eicu.apachepatientresult),

intakeoutput AS (
SELECT * FROM eicu.intakeoutput),

respchart AS (
SELECT * FROM eicu.respiratorycharting),
